class Model::Page::CreateEvent < SitePrism::Page
  ...
  element :summary_image_tab, "#node_event_form_group_summary_image .fieldset-title"
  ...
  section :summary_image_library, Model::Section::AddImageSection, "#node_event_form_group_summary_image"
