...
Then(/^the menu settings are not displayed$/) do
  @british_council.create_press_release.meta_config.should_not have_menu_settings
end

When /^I publish a press release$/ do
  @british_council.create_press_release.meta_config.publish_tab.click
  @british_council.create_press_release.meta_config.publish_settings.publish_status.click
end

When(/^I submit a published press release page$/) do
  step "I enter a title for a press release"
  step "I enter a publish date for a press release"
  step "I enter a summary for a press release"
  step "I enter a body for a press release"
  step "I enter a notes to editor for a press release"
  step "I enter a about the british council for a press release"
  step "I publish a press release"
  step "I save a press release"
end

When(/^I create a published press release page$/) do
  step "I navigate to the create press release page"
  step "I submit a published press release page"
